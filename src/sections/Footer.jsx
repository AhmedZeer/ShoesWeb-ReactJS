  ...
  return (
    <footer className="max-container">
      ...
      gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          font-montserrat text-white-400 sm:max-w-sm">
            SSasldfhasfAKLJDFGHASFDGH
            SasldfhasfAKLJDFGHASFDGH
            http://localhost
            asldfhasfAKLJDFGHASFDGH</p>
      ...
      <div className="flex justify-between text-white-400 mt-24
                      max-sm:flex-col max-sm:items-ceneter">
        <div className="flex flex-1 justify-start items-center
        gap-2 font-montserrat cursor-pointer">
          <img src={copyrightSign} alt="cp"
          width={20}
          height={20}
